;@+leo-ver=5-thin
;@+node:davy.20141213005428.81: * @file windows/leo.nsi
;@@language nsi
;@+<< include nsh >>
;@+node:davy.20141213005428.82: ** << include nsh >>
!include MUI2.nsh
!include nsDialogs.nsh
!include LogicLib.nsh
;@-<< include nsh >>
;@+<< define metadata >>
;@+node:davy.20141213005428.83: ** << define metadata >>
...
;@-<< define metadata >>
;@+<< prolog >>
;@+node:davy.20141213005428.84: ** << prolog >>
; Globals.
Var PythonDirectory
...
;@-<< prolog >>
;@+<< pages >>
;@+node:davy.20141213005428.85: ** << pages >>
;@@language nsi
Var StartMenuFolder
...
;@+others
;@+node:davy.20141213005428.86: ** onInit
...
;@+node:davy.20141213005428.87: ** Section Leo
...
File *.*
SectionEnd
;@+node:davy.20141213005428.88: ** Section File Association
...
SectionEnd
;@+node:davy.20141213005428.89: ** Section Desktop Shortcut
...
SectionEnd
;@+node:davy.20141213005428.90: ** Section Start Menu
...
SectionEnd
;@+node:davy.20141213005428.91: ** Section -Post
Section -Post
...
SectionEnd
;@+node:davy.20141213005428.92: ** Section Uninstall
Section Uninstall
