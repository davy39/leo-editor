;@+leo-ver=5-thin
;@+node:davy.20141202180209.129: * @file windows/leo.nsi
;@@language nsi
;@+<< include nsh >>
;@+node:davy.20141202180209.130: ** << include nsh >>
!include MUI2.nsh
!include nsDialogs.nsh
!include LogicLib.nsh
;@-<< include nsh >>
;@+<< define metadata >>
;@+node:davy.20141202180209.131: ** << define metadata >>
...
;@-<< define metadata >>
;@+<< prolog >>
;@+node:davy.20141202180209.132: ** << prolog >>
; Globals.
Var PythonDirectory
...
;voir quel repertoire demander
;!addincludedir C:\leo.repo\leo-editor\dist\windows
; Boilerplate
SetCompressor bzip2
...
;@-<< prolog >>
;@+<< pages >>
;@+node:davy.20141202180209.133: ** << pages >>
;@@language nsi
Var StartMenuFolder
...
;@+others
;@+node:davy.20141202180209.134: ** onInit
...
;@+node:davy.20141202180209.135: ** Section Leo
; The name of this section must be "Leo".
Section "Leo" SEC01
; Add all files and directories.
; We exclude directories with /x 
SetOutPath "$INSTDIR/leo"
SetOverwrite ifnewer
File /r leo
File *.*
SectionEnd
;@+node:davy.20141202180209.136: ** Section File Association
...
SectionEnd
;@+node:davy.20141202180209.137: ** Section Desktop Shortcut
...
SectionEnd
;@+node:davy.20141202180209.138: ** Section Start Menu
...
SectionEnd
;@+node:davy.20141202180209.139: ** Section -Post
Section -Post
...
SectionEnd
;@+node:davy.20141202180209.140: ** Section Uninstall
Section Uninstall
DeleteRegKey HKLM "${leo_hklm}"
DeleteRegKey HKCR "${ext}"
DeleteRegKey HKCR "${name}File"
; Safely removes all files and directories, including $INSTDIR.
; We do not RMDir /r "$INSTDIR in case that user install leo into a shared folder
; RMDir will remove $INSTDIR folder only if it is empty
RMDir /r "$INSTDIR\leo"
